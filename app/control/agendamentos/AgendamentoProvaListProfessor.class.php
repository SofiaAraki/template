...
class AgendamentoProvaListProfessor extends TPage
{
    ...
    public function __construct()
    {
        ...
        // create EDIT action
        /*$action_download = new TDataGridAction(array($this, 'onDownloadMaster'));
        //$action_edit->setUseButton(TRUE);
        //$action_edit->setButtonClass('btn btn-default');
        $action_download->setLabel('Download');
        $action_download->setImage('fa:cloud blue fa-lg');
    ...
    public function onSearch()
    {
        ...
        if (isset($data->data_prova) AND ($data->data_prova)) {
            $filter = new TFilter('data_prova', 'like', "%{$data->data_prova}%"); 
