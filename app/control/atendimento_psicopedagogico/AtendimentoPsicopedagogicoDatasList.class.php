 ...
 */
class AtendimentoPsicopedagogicoDatasList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $column_system_user_id = new TDataGridColumn('system_user->name', 'Nome', 'left');
    ...
    /** $action_edit = new TDataGridAction(array('AtendimentoPsicopedagogicoDatasFormList', 'onEdit'));
        ...
        $container->add(TPanelGroup::pack('Meu Agendamento', $this->datagrid, $this->pageNavigation));
