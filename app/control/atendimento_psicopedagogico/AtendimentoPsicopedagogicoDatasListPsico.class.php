 ...
 */
class AtendimentoPsicopedagogicoDatasListPsico extends TPage
{
    private $form; // form
    ...
    /** $action_edit = new TDataGridAction(array('AtendimentoPsicopedagogicoDatasFormList', 'onEdit'));
        ...
        $container->add(TPanelGroup::pack('Minha Agenda', $this->datagrid, $this->pageNavigation));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            $criteria->add(new TFilter('id_psico', '=', $logged->id));
