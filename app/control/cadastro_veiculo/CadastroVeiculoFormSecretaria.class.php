...
class CadastroVeiculoFormSecretaria extends TPage
{
    protected $form; 
    ...
    public function __construct( $param )
    {
        ...
        $itens_grupo = array();
        $itens_grupo['Aluno'] = 'Aluno';
        $itens_grupo['Professor'] = 'Professor';
        $itens_grupo['Colaborador'] = 'Colaborador';
        $itens_grupo['Motorista'] = 'Motorista';

        $grupo->addItems($itens_grupo);
        ...
        $nome->addValidation('"Nome do Condutor"', new TRequiredValidator());
        ...
        $this->form->addFields( [ new TLabel('Nome do Condutor:') ], [ $nome ], [ new TLabel('Grupo') ], [$grupo] );
        ...
        $container->add(new TXMLBreadCrumb('menu.xml', 'CadastroVeiculoListSecretaria'));
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            TApplication::loadPage('CadastroVeiculoListSecretaria', 'onReload');
        }
        catch (Exception $e) 
        {
