...
class CadastroVeiculoList extends TPage
{
    private $form; 
    private $datagrid; 
    ...
    public function __construct()
    {
        ...
        $this->form->addAction('Novo Cadastro',  new TAction(array('CadastroVeiculoForm', 'onEdit')), 'fa:plus green');
        ...
        $action_del = new TDataGridAction(array('CadastroVeiculoList', 'onGenerate'));
