...
class RequerimentoAlunoConnextFormView extends TPage
{
     protected $form;
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('RequerimentoAlunoConnextFormView');
    ...
    public function onPrint($param)
    {
        try
        {
            ...
            if ($req_aluno)
            {
                ...
                $html = new AdiantiHTMLDocumentParser('app/documents/RequerimentoAlunoConnext.html', 'A4', 'portrait');
