 ...
 */
class RequerimentoAlunoNSCFormView extends TPage
{
     protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('RequerimentoAlunoNSCFormView');
        $this->form->setFormTitle('Requerimento de Matrícula - NSC');
        ...
        try
        {
           ...
           // var_dump($param);
            ...
            if ($req_aluno)
            {
                ...
                $html = new AdiantiHTMLDocumentParser('app/documents/RequerimentoAluno.html', 'A4', 'portrait');
