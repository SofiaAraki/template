 ...
 */
class DespesaProfessorAnaliseList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $action1 = new TDataGridAction(array($this, 'alterarSituacao'));
        $action1->setLabel('Em análise');
        $action1->setImage('bs:hand-right green');
        $action1->setField('id');

        // create EDIT action
        $action_edit = new TDataGridAction(array('DespesaProfessorAnaliseForm', 'onEdit'));
        $action_edit->setLabel(('Analisar'));
        ...
        $action_view = new TDataGridAction(array($this, 'OnDespesaProfessorAnaliseFormView'));
        $action_view->setLabel('Visualizar');
        $action_view->setImage('fa:search #478fca');
        ...
        $action_group->addHeader('Alterar situação para:');
    ...
    /*    $action_edit = new TDataGridAction(array('DespesaProfessorAnaliseForm', 'onEdit'));
        ...
        //$action_edit = new TDataGridAction(array('DespesaProfessorAnaliseFormView', 'onShow'));
        $action_edit = new TDataGridAction(array($this, 'OnDespesaProfessorAnaliseFormView'));
        ...
        $container->add(TPanelGroup::pack('Analisar despesas', $this->datagrid, $this->pageNavigation));
    ...
    public function alterarSituacao($param)
    {
        try
        {
            TTransaction::open('Felabs_DB');
           
            $object = new DespesaProfessor($param['id']);
    ...
    public function OnDespesaProfessorAnaliseFormView($param)
    {
        ...
        TApplication::loadPage('DespesaProfessorAnaliseFormView','onShow', $parametros);
   ...
   //     var_dump($url);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            $criteria->add(new TFilter('situacao', 'IN',     array('Aberto', 'Em análise')));
            // default order
