 ...
 */
class DespesaProfessorParecerForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $obs_parecer = new TText('obs_parecer');
        ...
        $itens_situacao['Aguardando aprovação'] ='Aguardando aprovação';
        ...
        $this->form->addFields([new TLabel('Custo médio Km rodado (R$):')], [$custo_medio], [new TLabel('Data do registro:')],[$data_reg], [new TLabel('Total de despesas (R$):')], [$valor_total]);
    ...
    /**    $this->form->addFields([new TLabel('Categoria:')],[$item_despesa_item_tipo],[new TLabel('')]);
        ...
        $this->form->addFields( [new TFormSeparator('<i>Análise dos dados (Contabilidade)</i>')] );
        ...
        $this->form->addFields([new TLabel('Observação:')], [$obs_parecer], [new TLabel('')]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('DespesaProfessorParecerList', 'onReload', $param);
