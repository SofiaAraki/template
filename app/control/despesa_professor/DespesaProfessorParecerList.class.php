 ...
 */
class DespesaProfessorParecerList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('DespesaProfessorParecerForm', 'onEdit'));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            $criteria->add(new TFilter('situacao', 'like', 'Aguardando aprovação'));
