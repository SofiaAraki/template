...
class BuscaCidadeMantenedora extends TWindow
{
    private $form;
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_BuscaCidadeMantenedora');
        ...
        $column_Nome = new TDataGridColumn('Nome', 'Nome do município', 'left', 180);
        $column_Uf = new TDataGridColumn('Uf', 'UF', 'center', 50);
        $column_CEPINICIAL = new TDataGridColumn('fi_cidades_inep->CEPINICIAL', 'CEP', 'center', 80);
    ...
    public static function onSelect($param)
    {
        try
        {
            ...
            TForm::sendData('form_DiplomaDigitalMantenedora', $send);
