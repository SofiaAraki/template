...
class EstagioAnalisadoProfessorList extends TPage
{
    private $form; 
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('<h4>Estágios Analisados</h4>');
        ...
        $this->datagrid->setGroupColumn('nome_aluno', '<b>{nome_aluno} - HORAS INTEGRALIZADAS: {CalcularHorasAprovadas} horas</b>');
        ...
        $action_visualizar = new TDataGridAction(['EstagioAnalisadoProfessorFormView', 'onEdit']);
        $action_visualizar->setUseButton(TRUE);
        $action_visualizar->setButtonClass('btn btn-default');
        $action_visualizar->setLabel('Visualizar estágio');
