 ...
 */
class RequerimentoMatriculaFajob extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_RequerimentoMatriculaFajob');
        ...
        $Naturalidade = new TEntry('CIDADE_NASC');
        $NaturalidadeUF = new TEntry('UF_NASC');
        $Nacionalidade = new TEntry('Nacionalidade');
        $Rg = new TEntry('RG');
        $RgOrgaoExpedidor = new TEntry('RG_Origem');
        $CPF = new TEntry('CPF');
        $Endereco = new TEntry('Endereco');
        $EnderecoNumero = new TEntry('Numero');
        $EnderecoComplemeto = new TEntry('Complemento');
        $Bairro = new TEntry('Bairro');
        $CidadeInep = new TEntry('UF_RES');
        $Cep = new TEntry('Cep');
        $Telefone = new TEntry('TEL_CELULAR');
        $Email = new TEntry('Email');
        $Telefone2 = new TEntry('TEL_RESIDENCIAL');
       ...
       //  $output_type = new TRadioGroup('output_type');
        ...
        //$this->form->addFields( [ new TLabel('Cod. Aluno') ], [ $COD_INSCRICAO_VESTTIBULAR ]);
        ...
        $this->form->addFields( );
        $this->form->addFields( [ new TLabel('Bairro') ], [ $Bairro ],[ new TLabel('Cidade') ], [ $CidadeInep ],[ new TLabel('CEP') ], [ $Cep ]  );
       ...
       // $output_type->addValidation('Output', new TRequiredValidator);
        ...
        $Curso->addItems( [ 'Engenharia Civil' => 'Engenharia Civil',
        ...
        $Etapa->addItems( [ '1º Ciclo' => '1º Ciclo'] );
...
*/
        ...
        // set sizes
        $COD_INSCRICAO_VESTTIBULAR->setSize('20%');
        $Nome->setSize('100%');
...
*/
  ...
  /*      $RgResponsavel->setValue($rgresponsavel);
        ...
        $Nacionalidade->setValue("BRASILEIRA");
        $COD_INSCRICAO_VESTTIBULAR->setEditable(FALSE);
        ...
        if (!empty($COD_INSCRICAO_VESTTIBULAR))
        {
            $COD_INSCRICAO_VESTTIBULAR->setEditable(FALSE);
        }
        ...
        $this->form->addAction('Gerar Requerimento',  new TAction(array('RequerimentoAlunoFajobFormView','onPrint'), $param), 'fa:check-circle green');
