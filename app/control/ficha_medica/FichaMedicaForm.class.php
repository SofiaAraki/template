...
class FichaMedicaForm extends TPage
{
    protected $form;
...
////////////////////////////////////////////////////////CADASTRO FICHA MÉDICA   
        ...
        $this->form->addFields( [new TLabel('*Aluno(a):')],  [$cod_aluno]);       
        ...
        $this->form->addFields( [ new TLabel('*O(a) aluno(a) tem alergia a algum tipo de alimento?')], [$alergico_alimento_s_n ] );
        ...
        $this->form->addFields( [ new TLabel('Sim. Qual? (Número da Carteirinha)')], [$plano_de_saude ]);
        ...
        $nome->setSize('calc(100% - 120px)');
        $nome->style .= ';margin-left:10px';
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new FichaMedica($key); // instantiates the Active Record
