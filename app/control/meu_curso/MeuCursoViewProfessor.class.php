...
class MeuCursoViewProfessor extends TPage
{
    private $form;
    private $form2;
    private $datagrid;
    ...
    public function onCursoForm()
    {
        ...
        $criteria6->add(new TFilter('CodEntidade', '=', $loggedUnit), TExpression::AND_OPERATOR);
        $criteria6->add(new TFilter('CodProfessor', '=', $user->systemuser_codlegado), TExpression::AND_OPERATOR); 
        $criteria6->add(new TFilter('Ano', '=', $Ano), TExpression::AND_OPERATOR);

        $repos = VwProfessordisciplinassemestre::getObjects($criteria6);
    ...
    public function onVerPagina($param)
    {
        ...
        {
            new TMessage('info', 'Insira qual curso deseja visualizar', TApplication::loadPage('MeuCursoViewProfessor'));
        }
        else
        {
    ...
    public function verPagina($param)
    {
        ...
        // --- TÍTULO DA PÁGINA (Alinhado com a visualização do Aluno) ---
        ...
        // Empilhamento fluido idêntico ao do aluno
    ...
    public function onDownload($param)
    {
        try
        {
            ...
            {              
                ...
                TApplication::loadPage('MeuCursoViewProfessor', 'verPagina', $parametros);
            }
            else
            {
