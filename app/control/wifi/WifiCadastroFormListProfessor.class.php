...
class WifiCadastroFormListProfessor extends TPage
{
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // CORREÇÃO: Buscando a string 'userid' direto da sua sessão
            ...
            // CORREÇÃO: Filtrando diretamente com a string do ID do usuário logado
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            // CORREÇÃO: Coleta direta das strings escalares e arrays nativos da sessão
            $userName = TSession::getValue('username');   // 'SOFIA ARAKI'
            $userId   = TSession::getValue('userid');     // '6836'
            $userMail = TSession::getValue('usermail');   // 'sofia.araki@feituverava.com.br'
            $groupIDs = TSession::getValue('usergroupids'); // Array com grupos
            ...
            // CORREÇÃO: Vinculação direta com variáveis limpas da sessão
            $data->nome = $userName;
            ...
            // CORREÇÃO: Verificação in_array usando os dados reais extraídos do 'usergroupids'
            ...
            new TMessage('info', 'Os dados foram enviados com sucesso. Suas informações serão verificadas e, se estiverem corretas, o acesso do seu dispositivo a Wi-Fi será liberado em até 48 horas');
            $this->onReload(); 
            ...
            // CORREÇÃO: Varre os e-mails e envia com a string $userMail e $userName corretas da sessão
            if (!empty($userMail)) {
