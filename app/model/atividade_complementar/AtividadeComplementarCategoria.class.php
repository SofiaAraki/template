<?php
/**
 * AtividadeComplementarCategoria Active Record
 * @author  <your-name-here>
 */
class AtividadeComplementarCategoria extends TRecord
{
    const TABLENAME = 'atividade_complementar_categoria';
    const PRIMARYKEY= 'id';
     ...
     * Sample of usage: $categoria_atividade_complementar->diploma_digital_curso = $object;
     ...
     * Sample of usage: $categoria_atividade_complementar->diploma_digital_curso->attribute;
     ...
     * Sample of usage: $categoria_atividade_complementar->system_user = $object;
     ...
     * Sample of usage: $categoria_atividade_complementar->system_user->attribute;
