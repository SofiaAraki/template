<?php
/**
 * DadosAreaFormacao Active Record
 * @author  <your-name-here>
 */
class AreaFormacao extends TRecord
{
    const TABLENAME = 'dados_area_formacao';
    const PRIMARYKEY= 'id';
     ...
     * Sample of usage: $dados_area_formacao->diploma_digital_curso = $object;
     ...
     * Sample of usage: $dados_area_formacao->diploma_digital_curso->attribute;
     ...
     * Sample of usage: $dados_area_formacao->system_user = $object;
     ...
     * Sample of usage: $dados_area_formacao->system_user->attribute;
