<?php
/**
 * DiplomadigitalDadosTermoresponsabilidade Active Record
 * @author  <your-name-here>
 */
class DiplomaDigitalTermoResponsabilidade extends TRecord
{
    const TABLENAME = 'dados_termo_responsabilidade';
    const PRIMARYKEY= 'id';
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('nome_assinante');
        parent::addAttribute('cpf_assinante');
        parent::addAttribute('cargo_assinante');
        parent::addAttribute('ato_designacao');
        parent::addAttribute('caminho_ato');
     ...
     * Sample of usage: $diplomadigital_dados_termoresponsabilidade->diploma_digital_documentacao = $object;
     ...
     * Sample of usage: $diplomadigital_dados_termoresponsabilidade->diploma_digital_documentacao->attribute;
     ...
     * Sample of usage: $diplomadigital_dados_termoresponsabilidade->system_user = $object;
     ...
     * Sample of usage: $diplomadigital_dados_termoresponsabilidade->system_user->attribute;
