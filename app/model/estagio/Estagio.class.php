...
class Estagio extends TRecord
{
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('razao_social_empresa');
        parent::addAttribute('cnpj_empresa');
        ...
        parent::addAttribute('status_estagio');
        parent::addAttribute('observacao');
        parent::addAttribute('status_pdfa');
        parent::addAttribute('status_assinatura');
        parent::addAttribute('system_user_id');
        parent::addAttribute('data_reg');
        parent::addAttribute('opcao_estagio');
        parent::addAttribute('nome_pessoa_fisica');
        parent::addAttribute('cpf_pessoa_fisica');
        parent::addAttribute('cod_estagio_historico');
    }

    
    /**
     * Method set_diploma_digital_diplomado
     * Sample of usage: $estagio->diploma_digital_diplomado = $object;
     ...
     * Sample of usage: $estagio->diploma_digital_diplomado->attribute;
     ...
     * Sample of usage: $estagio->diploma_digital_curso = $object;
     ...
     * Sample of usage: $estagio->diploma_digital_curso->attribute;
     ...
     * Sample of usage: $estagio->historico_digital = $object;
     ...
     * Sample of usage: $estagio->historico_digital->attribute;
     ...
     * Sample of usage: $estagio->system_user = $object;
     ...
     * Sample of usage: $estagio->system_user->attribute;
