...
class VwProfessordisciplinassemestre extends TRecord
{
    ...
    static public function newFromLoginProf($sessao_prof)
    {
        $repos = new TRepository('VwProfessordisciplinassemestre');
        $criteria = new TCriteria;
        $criteria->add(new TFilter('CodGradeDisciplinaEtapaFrente', '=', $CodGradeDisciplinaEtapaFrente));
        //$criteria->add(new TFilter('CodDisciplina', '=', $sessao_prof));
    ...
    /**
     * Method get_system_user
     * Sample of usage: $vw_professordisciplinassemestre->fi_professor->attribute;
     * @returns SystemUser instance
     */
